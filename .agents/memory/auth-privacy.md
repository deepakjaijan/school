...
Student accounts should only receive their own student record and should not receive other students' phone numbers, emails, parent contacts, or addresses. Principal accounts can manage the full register and see private contact fields. Role detection currently relies on Clerk metadata or an approved school email domain.
